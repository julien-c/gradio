const textbox_input = {
  html: `
    <textarea class="input_text h-10 px-3 border border-gray-200 rounded-lg shadow-inner outline-none focus:ring-1 focus:ring-inset focus:ring-indigo-200 dark:focus:ring-indigo-50 focus:shadow-inner placeholder-gray-400 dark:bg-gray-925"></textarea>
    <div class="output_text"></div>
    `,
  one_line_html: `<input type="text" class="input_text h-10 px-3 border border-gray-200 rounded-lg shadow-inner outline-none focus:ring-1 focus:ring-inset focus:ring-indigo-200 dark:focus:ring-indigo-50 focus:shadow-inner placeholder-gray-400 dark:bg-gray-925">`,
  init: function(opts) {
    if (opts.lines > 1) {
